...
try{
  ...
  for(const name of ["schema.sql","002_saas_multiempresa.sql","003_perfis_e_tecnicos.sql","004_pagamentos_os.sql","005_atendentes_clientes.sql","006_pdv_completo.sql"]){
